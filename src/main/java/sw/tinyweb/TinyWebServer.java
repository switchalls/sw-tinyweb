 ...
 * 
 * <p>Can process basic HTTP 1.1 requests only.
 * </p>
 * 
 * <p>Designed for use on low powered embedded platforms.
 * </p>
 * 
 * @author $Author: $
 * @version $Revision: $
...
public class TinyWebServer implements Runnable
{
	 ...
	 * @param aWebContentHome Location of the web content folder
	 */
	 ...
	 * </p>
	 * 
	 * @param aPattern The URL pattern or "*" (match any)
	 * @param aServletName The servlet identifier
	 */
	 ...
	 * @param aURL The request path, eg. "/xyz"
	 * @return the servlet
	 * @throws Exception when the servlet cannot be created
	 * 
	...
	public void run()
	{
    	...
    	try
    	{
    		...
    		for ( String clazz : this.servletCache.keySet() )
    		{
	 ...
	 * 
	 * @param aContext The application context
	 * @param aSocket The socket on which the request was received
	 * @throws Exception when the request cannot be processed
	 * 
	 * @see #createServletByPath(ServletContext, String)
	 * @see #executeServlet(Socket, Servlet, TinyWebRequest, TinyWebResponse)
	 */
	protected void processRequest(ServletContext aContext, Socket aSocket)
	throws Exception
	{
	 ...
	 * 
	 * @param aClientSocket The socket associated with the request
	 * @param aServlet The servlet
	 * @param aRequest The HTTP request
	 * @param aResponse The HTTP response
	 * 
	 * @see #findServletConfigByPath(String)
	 */
	protected void executeServlet(
	 ...
	 */
	protected void fireContextInitialized(ServletContext aContext)
	{
		final ServletContextEvent evt = new ServletContextEvent( aContext );
		for ( ServletContextListener l : this.contextListeners )
		{
	 ...
	 * @param aContext The new context
	 */
	protected void fireContextDestroyed(ServletContext aContext)
	{
		final ServletContextEvent evt = new ServletContextEvent( aContext );
		for ( ServletContextListener l : this.contextListeners )
		{
