...
public class JsonWriter {
     ...
     *            The HTTP response
     * @param aCallback
     *            The callback method or null (return JSON stream)
     * @throws IOException
     *             when the response writer cannot be created
     *
     ...
     *
     * <p>
     * If <code>aCallback</code> defined, creates the
     ...
     *            The XML document
     * @throws Exception
     *             when the document cannot be converted
     *
     * @see #printXmlDocument(InputStream)
     */
    public void printXmlDocument(String aXML) throws Exception {
     ...
     */
    public void printXmlDocument(InputStream aXML) throws Exception {
     ...
     *
     * <p>
     * Auto wraps strings with double quotes.
     * </p>
     *
     * @param aText
     *            The text
