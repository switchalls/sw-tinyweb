 ...
 * 
 * <p>See HTTP 1.1 <a href="http://www.w3.org/Protocols/rfc2616/rfc2616">specification</a>.
 * </p>
 * 
 * @author $Author: $
 * @version $Revision: $
...
public class HttpHeaderUtils
{
	 ...
	 * Extract the cookie.
	 * 
	 * @param aText The text from the HTTP header
	 * @return the new cookie
	 * @throws TinyWebException when the cookie information is rejected
	 */
	public Cookie parseCookie(String aText)
	 ...
	 * @param aLocale The target locale
	 * 
	 ...
	 * 
	 * @param aTime The date to be formatted
	 * @param aLocale The target locale
	 ...
	 * @return the date
	 * @throws TinyWebException when the date cannot be created
	 */
	public Date parseDate(String aText)
	throws TinyWebException
	{
	 ...
	 * @throws IllegalArgumentException when the text is rejected
	 */
	public List<LanguageTag> parseLanguages(String aText)
