...
public class ServletUtils {
     ...
     *            The output
     * @throws IOException
     *             when data cannot be read or written
     */
     ...
     * @return the contents
     * @throws IOException
     *             when data cannot be read
     */
    public static String readContent(InputStream aIn) throws IOException {
     ...
     *
     * <p>
     * Uses the file extension, eg. <code>XYZ.gif</code> =
     * <code>image/gif</code>.
     * </p>
     *
     * <p>
     * Defaults to <code>text/plain</code> for unrecognised
     * file extensions.
     * </p>
     *
     * @param aPath
     ...
     *
     * <p>
     * URL format: <b>http://</b> &lt;server name&gt;
     ...
     *            The target action
     * @param aSessionId
     *            The identifier for this HTTP session
     * @return the URL
     */
     ...
     *
     * <p>
     * If a <code>requestedSessionId</code> has been set on the HTTP
