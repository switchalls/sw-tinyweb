...
public class TinyWebRequest implements HttpServletRequest {
    ...
    public Enumeration<Locale> getLocales() {
        ...
        for (final LanguageTag language : languages) {
     ...
     *
     * @param aList
     *            The list of unique languages
     * @param aText
     *            The header text
     * @throws IllegalArgumentException
     *             when the language tags cannot be extracted
     */
    private void addLanguage(List<LanguageTag> aList, String aText)
            throws IllegalArgumentException {

        final List<LanguageTag> tags = HttpHeaderUtils.getInstance().parseLanguages(aText);
        for (final LanguageTag lt : tags) {
     ...
     * @param aLanguage
     *            The RFC 1766 language tag
     * @return the tag
     */
    @Nullable
    private LanguageTag findLanguage(List<LanguageTag> aLanguages, String aLanguage) {
        for (final LanguageTag lt : aLanguages) {
     ...
     * @return the new path
     */
    private String createAbsolutePath(String aCurrentLocation, String aRelativePath) {
    ...
    /**
     * @param aLen
     *            The new value or -1 (length unknown)
     */
     ...
     *            The input stream
     * @throws IOException
     *             when the header information cannot be read
     * @throws TinyWebException
     *             when the header content is rejected
     *
     * @see #parseHeaderLine(String)
     */
    public void initRequest(InputStream aIn) throws IOException, TinyWebException {
     ...
     * @see HttpHeaderUtils
     */
    private void parseHeaderLine(String aText) throws TinyWebException {
     ...
     */
    private void parseRequestUrl(String aUrl) throws IllegalArgumentException {
     ...
     *
     * <p>
     * For example, <code>userid=joe&password=guessme</code>
     * </p>
     *
     * @param aParams
     *            The URL parameter list
     * @throws IllegalArgumentException
     *             when the parameters are rejected
     */
    private void parseRequestUrlParameters(String aParams) throws IllegalArgumentException {
