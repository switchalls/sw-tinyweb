...
public class URLHelper
{
	 ...
	 * 
	 * @param aResourceURL The URL
	 * @param aLastSlashPos Position of the last '/'
	 * @return the URL as a string
	 ...
	 * Get the URL to the resource's parent folder.
	 * 
	 * <p>NB. <code>jar:</code> URLs must always contain <code>!/</code>.
	 * </p>
	 * 
	 * @param aResourceURL The URL
	 * @param aLastSlashPos Position of the last '/'
     ...
     * @return the new URL
     * @throws MalformedURLException when the new URL cannot be created
     * @see #newURL(String, String)
     */
	public static URL newURL(URL aBaseURL, String aPath)
     ...
     * Append the path to the URL.
     * 
     * <p>Not all URL protocols implement the same path constructs. For example,
     * the <code>file:</code> protocol will accept <code>./</code> and
     * <code>../</code> where the <code>jar:</code> protocol will reject them.
     * </p>
     * 
     * <p>Some URL types must adhere to a specific syntax. For example,
     ...
     * </p>
     * 
     * <p>This helper method will assemble the URL in the correct manner
     ...
     * @throws MalformedURLException when the new URL cannot be created
     */
	public static String newURL(String aBaseURL, String aPath)
	throws MalformedURLException
    {
